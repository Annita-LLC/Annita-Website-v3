        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <p className="text-gray-600 mb-4">These cookies are necessary for the website to function properly and provide core features.</p>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <p className="text-gray-600 mb-4">These cookies enhance functionality and remember your preferences for a better experience.</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <p className="text-gray-600 mb-4">These cookies help us understand how visitors interact with our website to improve performance.</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">Manage cookies through your browser preferences</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              <div className="p-2 bg-cyan-100 rounded-lg w-fit mb-3">
              ...
              <p className="text-sm text-gray-600">Use our cookie management tool</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              <div className="p-2 bg-cyan-100 rounded-lg w-fit mb-3">
              ...
              <p className="text-sm text-gray-600">Use incognito/private mode</p>
            </div>
          </div>
        </div>
      )
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <p className="text-sm text-gray-600">These cookies cannot be disabled as they are essential for the website to function properly.</p>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Functional Cookies</h4>
                    <p className="text-sm text-gray-600">Enhance functionality and personalization</p>
                  </div>
                </div>
              ...
              <p className="text-sm text-gray-600">Help us remember your preferences and provide enhanced functionality.</p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <p className="text-sm text-gray-600">Allow us to analyze website usage and improve user experience.</p>
            </div>
          </div>
