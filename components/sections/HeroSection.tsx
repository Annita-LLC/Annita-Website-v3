            ...
            >
              ...
              <div className="relative mx-auto w-64 sm:w-72 md:w-80 h-[560px] sm:h-[630px] md:h-[700px] bg-gradient-to-b from-gray-900 via-gray-800 to-black rounded-[2rem] sm:rounded-[2.5rem] md:rounded-[3rem] p-2 sm:p-2.5 md:p-3 shadow-2xl">
                ...
                <motion.div
                  ...
                  className="absolute -top-4 -right-4 sm:-top-6 sm:-right-6 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-2xl sm:rounded-3xl shadow-2xl flex items-center justify-center"
                >
                ...
                <motion.div
                  ...
                  className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-gradient-to-br from-green-400 to-blue-500 rounded-xl sm:rounded-2xl shadow-2xl flex items-center justify-center"
                >
                  <Rocket className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-white" />
                </motion.div>
                ...
                <motion.div
                  ...
                  className="absolute top-1/2 -right-6 sm:-right-8 w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-gradient-to-br from-purple-400 to-pink-500 rounded-xl sm:rounded-2xl shadow-2xl flex items-center justify-center"
                >
                  <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
                </motion.div>

                {/* Device Ecosystem Icons */}
                <div className="absolute -top-8 sm:-top-10 md:-top-12 left-1/2 transform -translate-x-1/2 flex space-x-2 sm:space-x-3 md:space-x-4">
                  <motion.div
                    animate={{ y: [0, -10, 0] }}
                    transition={{ duration: 3, repeat: -1, delay: 0 }}
                    className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-white/20 rounded-lg flex items-center justify-center backdrop-blur-sm"
                  >
                    <Smartphone className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-white" />
                  </motion.div>
                  <motion.div
                    animate={{ y: [0, -10, 0] }}
                    ...
                    className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-white/20 rounded-lg flex items-center justify-center backdrop-blur-sm"
                  >
                    <Tablet className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-white" />
                  </motion.div>
                  <motion.div
                    animate={{ y: [0, -10, 0] }}
                    ...
                    className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-white/20 rounded-lg flex items-center justify-center backdrop-blur-sm"
                  >
                    <Monitor className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-white" />
                  </motion.div>
                  <motion.div
                    animate={{ y: [0, -10, 0] }}
                    ...
                    className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-white/20 rounded-lg flex items-center justify-center backdrop-blur-sm"
                  >
                    <Watch className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-white" />
                  </motion.div>
                </div>
              </div>
            </motion.div>
