...
import { Search, X, ArrowRight, Clock, FileText, Users, ShoppingCart, CreditCard, Truck, Zap, MessageSquare } from 'lucide-react'
...
const searchData: SearchResult[] = [
  // Services
  { id: 'marketplace', title: 'Annita Marketplace', description: 'Multivendor E-commerce Platform for Buyers, Sellers & Logistics', href: '/services/marketplace', category: 'Services', icon: ShoppingCart },
  { id: 'annitapay', title: 'AnnitaPay', description: "Africa's Unified Financial Engine", href: '/services/annitapay', category: 'Services', icon: CreditCard },
  { id: 'logistics', title: 'Annita Logistics', description: 'On-Demand Delivery Network', href: '/services/logistics', category: 'Services', icon: Truck },
  { id: 'connect', title: 'Annita Connect', description: 'Communication & Marketing Suite', href: '/services/connect', category: 'Services', icon: MessageSquare },
  { id: 'ai', title: 'Annita AI', description: 'Artificial Intelligence Platform', href: '/services/ai', category: 'Services', icon: Zap },
                    ...
                    <div className="py-4">
                      ...
                      <div className="px-3 sm:px-4 py-2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          {['Annita Marketplace', 'AnnitaPay', 'Annita AI', 'Annita Logistics'].map((term) => (
                            <button
                              key={term}
