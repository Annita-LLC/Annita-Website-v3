  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center p-2 sm:p-4 z-50 pointer-events-none">
        <div className="pointer-events-auto w-full max-w-[95vw] sm:max-w-2xl lg:max-w-3xl">
            ...
            <div className="px-4 sm:px-6 py-4 sm:py-5 overflow-y-auto max-h-[calc(85vh-100px)] sm:max-h-[calc(90vh-120px)]">
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    onClick={acceptAll}
                    className="px-3 py-1.5 bg-green-100 hover:bg-green-200 dark:bg-green-900/30 dark:hover:bg-green-900/50 text-green-700 dark:text-green-300 text-xs font-medium rounded-lg transition-colors duration-200"
                  >
                    Accept All
                  </button>
                  <button
                    onClick={declineAll}
                    className="px-3 py-1.5 bg-red-100 hover:bg-red-200 dark:bg-red-900/30 dark:hover:bg-red-900/50 text-red-700 dark:text-red-300 text-xs font-medium rounded-lg transition-colors duration-200"
                  >
                    Decline All
                  </button>
                  <button
                    onClick={resetToDefaults}
                    className="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs font-medium rounded-lg transition-colors duration-200 flex items-center gap-1"
                  >
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  disabled={!hasChanges}
                  className={`flex-1 flex items-center justify-center gap-2 font-medium py-2.5 px-4 rounded-lg transition-colors duration-200 text-sm ${
                    hasChanges
                ...
                <button
                  onClick={onClose}
                  className="flex-1 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium py-2.5 px-4 rounded-lg transition-colors duration-200 text-sm"
                >
                  Cancel
                </button>
              </div>
