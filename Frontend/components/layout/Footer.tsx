  ...
  const footerSections = [
    {
      title: 'Services',
      links: [
        { name: 'Annita Marketplace', href: '/services/marketplace', description: 'Multivendor E-commerce Platform' },
        { name: 'AnnitaPay', href: '/services/annitapay', description: "Africa's Unified Financial Engine" },
        { name: 'Annita Logistics', href: '/services/logistics', description: 'On-Demand Delivery Network' },
        { name: 'Annita Connect', href: '/services/connect', description: 'Communication & Marketing Suite' },
        { name: 'Annita AI', href: '/services/ai', description: 'Artificial Intelligence Platform' },
      ]
    },
    {
      title: 'Company',
