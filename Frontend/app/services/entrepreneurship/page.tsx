...
const EntrepreneurshipPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Strategies for growing and scaling your business",
      color: "green"
    },
    {
      icon: Users,
    ...
    },
    {
      icon: Target,
      title: "Goal Setting",
      description: "Set and achieve your business goals",
      color: "purple"
    }
  ]
  ...
  return (
    <>
      <SEOHead
        title="Entrepreneurship Courses - Annita"
        description="Learn how to start and run a business. Business planning, growth strategies, and networking for African entrepreneurs."
        keywords={[
          'entrepreneurship', 'business courses', 'start a business', 'business planning',
          'entrepreneur training', 'business growth', 'networking', 'mentorship'
        ]}
        canonical="/services/entrepreneurship"
        ogImage="/images/og/entrepreneurship.jpg"
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-yellow-50">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Learn How to Start & <span className="text-amber-600">Run a Business</span>
                  </h1>
                  
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    Turn your ideas into successful businesses with our comprehensive entrepreneurship courses. 
                    Learn business planning, growth strategies, and networking.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Why Choose <span className="text-amber-600">Annita Entrepreneurship</span>?
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Built specifically for African entrepreneurs with local market insights and cultural relevance.
                </p>
              </div>
        ...
        {/* Entrepreneurship Features Section */}
        <section className="py-16 sm:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Entrepreneurship <span className="text-green-600">Features</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Everything you need for successful entrepreneurship across Africa.
                </p>
              </div>
