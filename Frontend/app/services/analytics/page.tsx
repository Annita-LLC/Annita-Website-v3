...
const AnalyticsPage = () => {
  ...
  const features = [
    {
      ...
      description: "Track sales performance and growth metrics",
      color: "blue"
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: "Live data updates and alerts",
      color: "purple"
    }
  ]
  ...
  return (
    <>
      <SEOHead
        title="Analytics Dashboard - Annita"
        description="Track sales, performance, and growth metrics with our analytics dashboard. Real-time monitoring, data visualization, and business insights for African businesses."
        keywords={[
          'analytics', 'dashboard', 'business intelligence', 'data visualization',
          'performance tracking', 'sales analytics', 'business insights'
        ]}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Track Sales, Performance & <span className="text-rose-600">Growth Metrics</span>
                  </h1>
                  
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    Make data-driven decisions with our comprehensive analytics dashboard. 
                    Real-time monitoring, beautiful visualizations, and actionable insights.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Why Choose <span className="text-rose-600">Annita Analytics</span>?
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Built specifically for African businesses with local market insights and performance tracking.
                </p>
              </div>
        ...
        <section className="py-16 sm:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Analytics <span className="text-green-600">Features</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Everything you need for comprehensive business analytics across Africa.
                </p>
              </div>
