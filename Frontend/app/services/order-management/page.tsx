...
const OrderManagementPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Seamlessly integrate with inventory management",
      color: "green"
    },
    {
      icon: Clock,
    ...
    },
    {
      ...
      description: "Automate order fulfillment processes",
      color: "purple"
    }
  ]
  ...
  return (
    <>
      <SEOHead
        title="Order Management - Annita"
        description="Process and fulfill orders efficiently. Real-time order tracking, automated workflows, and inventory integration for African businesses."
        keywords={[
          'order management', 'order processing', 'fulfillment', 'order tracking',
          'inventory integration', 'automated workflows', 'order analytics'
        ]}
        canonical="/services/order-management"
        ogImage="/images/og/order-management.jpg"
      />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Process & Fulfill Orders <span className="text-cyan-600">Efficiently</span>
                  </h1>
                  
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    Streamline your order processing with automated workflows, 
                    real-time tracking, and seamless inventory integration.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Why Choose <span className="text-cyan-600">Annita Order Management</span>?
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Built specifically for African businesses with automated workflows and real-time tracking.
                </p>
              </div>
        ...
        <section className="py-16 sm:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Order <span className="text-green-600">Features</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Everything you need for efficient order management across Africa.
                </p>
              </div>
