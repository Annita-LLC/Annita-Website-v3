...
const AIPage = () => {
  ...
  const benefits = [
    ...
    },
    {
      icon: Target,
      title: 'Personalized',
      description: 'AI-powered personal assistant for your business.'
    }
  ]
  ...
  return (
    <>
      <SEOHead
        title="Annita AI - Personal AI Assistant"
        description="Personal AI assistant with intelligent automation, predictive analytics, and business insights. AI-powered business intelligence and automation."
        keywords={["ai", "artificial intelligence", "assistant", "automation", "analytics", "annita ai"]}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="text-center lg:text-left">
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                    Personal AI <span className="text-teal-200">Assistant</span>
                  </h1>
                  <p className="text-lg sm:text-xl text-teal-100 max-w-2xl mx-auto lg:mx-0 leading-relaxed mb-8">
                    Intelligent automation and AI-powered insights to optimize business operations 
                    and drive growth for MSMEs with real-time learning and adaptation.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
                  Artificial Intelligence <span className="text-orange-600">Platform</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Intelligent automation and AI-powered insights to optimize business operations and drive growth.
                </p>
              </motion.div>
