...
const DigitalSkillsPage = () => {
  ...
  const features = [
    {
      ...
      description: "Improve computer and internet skills",
      color: "blue"
    },
    {
      icon: Smartphone,
      title: "Mobile Technology",
      description: "Learn mobile device usage and apps",
      color: "green"
    },
    {
      icon: Globe,
      title: "Internet Navigation",
      description: "Master internet browsing and online tools",
      color: "orange"
    },
    {
      icon: Code,
      title: "Digital Tools",
      description: "Learn to use digital tools and platforms",
      color: "purple"
    }
  ]
  ...
  return (
    <>
      <SEOHead
        title="Digital Skills Training - Annita"
        description="Improve computer and internet skills. Digital tools training, online safety, and digital communication for African individuals."
        keywords={[
          'digital skills', 'computer skills', 'internet skills', 'digital literacy',
          'technology training', 'digital tools', 'online safety', 'digital communication'
        ]}
        canonical="/services/digital-skills"
        ogImage="/images/og/digital-skills.jpg"
      />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Improve Computer & <span className="text-cyan-600">Internet Skills</span>
                  </h1>
                  
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    Build your digital confidence with comprehensive skills training. 
                    Learn computer basics, internet navigation, and digital tools.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Why Choose <span className="text-cyan-600">Annita Digital Skills</span>?
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Built specifically for African individuals with practical, real-world digital skills training.
                </p>
              </div>
        ...
        <section className="py-16 sm:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Digital Skills <span className="text-green-600">Features</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Everything you need for comprehensive digital skills development across Africa.
                </p>
              </div>
