...
const CRMPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Track all customer communications in one place",
      color: "green"
    },
    {
      icon: Target,
      title: "Lead Management",
      description: "Convert prospects into customers with sales pipeline",
      color: "orange"
    },
    {
      icon: BarChart3,
  ...
  return (
    <>
      <SEOHead
        title="Customer Relationship Management (CRM) - Annita"
        description="Manage customer data and interactions with our CRM system. Centralized customer database, communication tracking, and sales pipeline management for African businesses."
        keywords={[
          'CRM', 'customer management', 'sales pipeline', 'lead management',
          'customer database', 'communication tracking', 'sales analytics'
        ]}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Manage Customer Data & <span className="text-violet-600">Interactions</span>
                  </h1>
                  
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    Build stronger customer relationships with our comprehensive CRM system. 
                    Track interactions, manage sales pipeline, and grow your business.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Why Choose <span className="text-violet-600">Annita CRM</span>?
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Built specifically for African businesses with local customer insights and sales tools.
                </p>
              </div>
        ...
        <section className="py-16 sm:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  CRM <span className="text-green-600">Features</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Everything you need for effective customer relationship management across Africa.
                </p>
              </div>
