...
const HealthcarePage = () => {
  ...
  const features = [
    {
      ...
      description: "Book appointments, telemedicine, health records",
      color: "blue"
    },
    {
      icon: Video,
      title: "Telemedicine",
      description: "Consult with doctors via video calls",
      color: "green"
    },
    {
      icon: FileText,
  ...
  return (
    <>
      <SEOHead
        title="Healthcare Services - Annita"
        description="Book appointments, telemedicine, health records. Comprehensive healthcare services for African individuals and families."
        keywords={[
          'healthcare', 'telemedicine', 'appointment booking', 'health records',
          'medical services', 'health monitoring', 'healthcare access'
        ]}
        canonical="/services/healthcare"
        ogImage="/images/og/healthcare.jpg"
      />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Book Appointments, Telemedicine & <span className="text-green-600">Health Records</span>
                  </h1>
                  
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    Access comprehensive healthcare services. Book appointments, 
                    consult with doctors online, and manage your health records.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Why Choose <span className="text-green-600">Annita Healthcare</span>?
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Built specifically for African healthcare with local providers and telemedicine solutions.
                </p>
              </div>
        ...
        <section className="py-16 sm:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Healthcare <span className="text-blue-600">Features</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Everything you need for comprehensive healthcare across Africa.
                </p>
              </div>
