...
const OnlineLearningPage = () => {
  ...
  const features = [
    {
      ...
      description: "Access courses and certifications online",
      color: "blue"
    },
    {
      icon: GraduationCap,
      title: "Skill Development",
      description: "Develop new skills with expert instructors",
      color: "green"
    },
    {
      icon: Award,
      title: "Certifications",
      description: "Earn recognized certifications and credentials",
      color: "orange"
    },
    {
      icon: Users,
  ...
  return (
    <>
      <SEOHead
        title="Online Learning Platform - Annita"
        description="Access courses and certifications online. Skill development, interactive learning, and recognized certifications for African individuals."
        keywords={[
          'online learning', 'courses', 'certifications', 'skill development',
          'education', 'training', 'learning platform', 'online education'
        ]}
        canonical="/services/online-learning"
        ogImage="/images/og/online-learning.jpg"
      />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Access Courses & <span className="text-indigo-600">Certifications</span>
                  </h1>
                  
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    Develop new skills and advance your career with our online learning platform. 
                    Access courses, earn certifications, and learn from expert instructors.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Why Choose <span className="text-indigo-600">Annita Learning</span>?
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Built specifically for African learners with local content and cultural relevance.
                </p>
              </div>
        ...
        <section className="py-16 sm:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Learning <span className="text-green-600">Features</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Everything you need for effective online learning across Africa.
                </p>
              </div>
