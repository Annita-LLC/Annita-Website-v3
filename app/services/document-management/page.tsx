...
const DocumentManagementPage = () => {
  ...
  const features = [
    {
      ...
      description: "Store and organize business documents securely",
      color: "blue"
    },
    {
      icon: Search,
      title: "Quick Search",
      description: "Find documents instantly with powerful search",
      color: "green"
    },
    {
      icon: Shield,
      title: "Secure Access",
      description: "Control access with advanced security features",
      color: "orange"
    },
    {
      icon: FileText,
  ...
  return (
    <>
      <SEOHead
        title="Document Management - Annita"
        description="Store and organize business documents securely. Advanced search, version control, and secure access for African businesses."
        keywords={[
          'document management', 'document storage', 'file organization', 'document search',
          'version control', 'secure access', 'document collaboration'
        ]}
        canonical="/services/document-management"
        ogImage="/images/og/document-management.jpg"
      />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Store & Organize Business <span className="text-slate-600">Documents</span>
                  </h1>
                  
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    Keep your business documents organized and secure with advanced search, 
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Why Choose <span className="text-slate-600">Annita Document Management</span>?
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Built specifically for African businesses with secure storage and collaborative features.
                </p>
              </div>
        ...
        <section className="py-16 sm:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Document <span className="text-green-600">Features</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Everything you need for efficient document management across Africa.
                </p>
              </div>
