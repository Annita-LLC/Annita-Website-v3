...
const KYCVerificationPage = () => {
  ...
  const features = [
    {
      ...
      description: "Verify business identity and compliance",
      color: "blue"
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: "Verify business documents and credentials",
      color: "orange"
    },
    {
      icon: CheckCircle,
      title: "Automated Process",
      description: "Streamlined and automated verification process",
      color: "purple"
    }
  ]
  ...
  return (
    <>
      <SEOHead
        title="KYC Verification - Annita"
        description="Verify business identity and compliance. Document verification, security protocols, and regulatory compliance for African businesses."
        keywords={[
          'KYC verification', 'business identity', 'compliance', 'document verification',
          'regulatory compliance', 'business verification', 'identity verification'
        ]}
        canonical="/services/kyc-verification"
        ogImage="/images/og/kyc-verification.jpg"
      />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Verify Business Identity & <span className="text-slate-600">Compliance</span>
                  </h1>
                  
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    Ensure your business meets all regulatory requirements with our KYC verification service. 
                    Document verification, security protocols, and compliance checking.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Why Choose <span className="text-slate-600">Annita KYC</span>?
                </h2>
        ...
        <section className="py-16 sm:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  KYC <span className="text-green-600">Features</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Everything you need for comprehensive business verification across Africa.
                </p>
              </div>
