  ...
  return (
    <>
      <SEOHead
        ...
        description="Encrypted messaging with file sharing and video calls. Communication hub for businesses and customers with AI-powered marketing tools."
        keywords={["messaging", "communication", "marketing", "video calls", "annita connect"]}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="text-center lg:text-left">
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                    Encrypted <span className="text-purple-200">Messaging</span>
                  </h1>
                  <p className="text-lg sm:text-xl text-purple-100 max-w-2xl mx-auto lg:mx-0 leading-relaxed mb-8">
                    Encrypted messaging with file sharing and video calls. Communication hub for businesses and customers 
                    with AI-powered marketing tools and customer engagement.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
                  Communication & <span className="text-orange-600">Marketing Suite</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Lower customer acquisition costs through affordable, data-backed marketing and customer engagement tools.
                </p>
              </motion.div>
