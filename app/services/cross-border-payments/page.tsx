...
const CrossBorderPaymentsPage = () => {
  ...
  const features = [
    {
      ...
      description: "Send and receive money across African countries in seconds",
      color: "blue"
    },
    {
      icon: Shield,
    ...
    },
    {
      icon: Globe,
      title: "54 Countries",
      description: "Process payments across all African countries seamlessly",
      color: "orange"
    },
    {
      icon: Lock,
  ...
  return (
    <>
      <SEOHead
        title="Cross-Border Payment Processing - Annita"
        description="Send and receive money across African countries with our secure cross-border payment processing. Instant transfers, low fees, and bank-grade security."
        keywords={[
          'cross-border payments', 'money transfer', 'African payments', 'international transfers',
          'secure payments', 'instant transfers', 'low fees'
        ]}
        canonical="/services/cross-border-payments"
        ogImage="/images/og/cross-border-payments.jpg"
      />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Send & Receive Money Across <span className="text-green-600">54 African Countries</span>
                  </h1>
                  
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    Process payments across African countries with instant transfers, low fees, 
                    and bank-grade security. Built for African businesses and individuals.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Why Choose <span className="text-green-600">Annita Payments</span>?
                </h2>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Everything you need for seamless cross-border payments across Africa.
                </p>
              </div>
